...
const localMiddleware = require('./local-middleware');
const validateOptions = require('schema-utils');
const isAbsoluteUrl = require('is-absolute-url');
const normalizeOptions = require('webpack-dev-server/lib/utils/normalizeOptions');
const updateCompiler = require('webpack-dev-server/lib/utils/updateCompiler');
...
const runBonjour = require('webpack-dev-server/lib/utils/runBonjour');
const routes = require('webpack-dev-server/lib/utils/routes');
const getSocketServerImplementation = require('webpack-dev-server/lib/utils/getSocketServerImplementation');
const schema = require('webpack-dev-server/lib/options.json');
...
class WebpackDevServer {
  constructor(compiler, options = {}, _log) {
    ...
    validateOptions(schema, options, 'webpack Dev WebpackDevServer');
  ...
  setupDevMiddleware() {
    ...
    const self=this;
    if (localMiddleware) {
      localMiddleware().map(function (middleware) {
  ...
  getStats(statsObj) {
    const stats = WebpackDevServer.DEFAULT_STATS;
...
WebpackDevServer.addDevServerEntrypoints = require('webpack-dev-server/lib/utils/addEntries');
